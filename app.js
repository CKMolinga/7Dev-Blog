...
app.get('/', (req, res) => {
    const blogs = [
        { title: 'Front End Development Trends to Watch in 2022', snippet: 'Front end development hasnt always gotten the respect it deserves compared to back end development. Many engineers used to look down on JavaScript. But times have changed. Web applications are growing rapidly, mainly due to the development of open-source tools.' },
